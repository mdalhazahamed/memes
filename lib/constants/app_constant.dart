...
class AppConstant {
  ...
  static const google_api_key = 'AIzaSyDejg4lf0OSjMn88nwTxRFS14ymqX6K7NA';
  static const String keyNotificationToken = "keyNotificationToken";

  ///
  static const Color primaryColor = Color(0xFF222737);

  static const Color secondaryColor = Color(0xFF245C5E);
  static const Color buttonBodyColor = Color(0xFF27D3B4);

  static const Color ontapRoundCounr = Color(0xFF2DFAD5);
  static const Color whiteColor = Colors.white;
  static const Color greyColor = Color(0xFF8993AD);

  // static const Color primaryColor = Color.fromRGBO(175, 214, 2, 1);
